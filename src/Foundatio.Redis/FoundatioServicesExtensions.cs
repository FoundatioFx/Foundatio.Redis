...
{
    public static FoundatioBuilder UseRedis(this FoundatioBuilder.Caching builder)
    {
    ...
    public static FoundatioBuilder UseRedis(this FoundatioBuilder.Caching builder, RedisCacheClientOptions options)
    {
        IFoundatioBuilder foundatioBuilder = builder;
    ...
    public static FoundatioBuilder UseRedis(this FoundatioBuilder.Caching builder, Builder<RedisCacheClientOptionsBuilder, RedisCacheClientOptions> config)
    {
        IFoundatioBuilder foundatioBuilder = builder;
        foundatioBuilder.Services.ReplaceSingleton<ICacheClient>(sp =>
        {
    ...
    public static FoundatioBuilder UseRedis(this FoundatioBuilder.Messaging builder)
    {
        IFoundatioBuilder foundatioBuilder = builder;
    ...
    public static FoundatioBuilder UseRedis(this FoundatioBuilder.Messaging builder, RedisMessageBusOptions options)
    {
        IFoundatioBuilder foundatioBuilder = builder;
    ...
    public static FoundatioBuilder UseRedis(this FoundatioBuilder.Messaging builder, Builder<RedisMessageBusOptionsBuilder, RedisMessageBusOptions> config)
    {
        IFoundatioBuilder foundatioBuilder = builder;
        foundatioBuilder.Services.ReplaceSingleton<IMessageBus>(sp =>
        {
